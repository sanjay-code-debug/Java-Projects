 ...
 <html lang="en">
   ...
   <body style="background-color: beige;">
     <nav id="navbar-example2" class="navbar navbar-light bg-light">
         <a class="navbar-brand" href="home.jsp">Student_Support</a>
       ...
       <div class="alert alert-success" role="alert" style="text-align: center;">
         <h4 class="alert-heading">Well Come To Home Page</h4>
         <p>Choose Any Of the Following Test to Check Your Knowledge About This Subject</p>
       </div>
